...
\begin{enumerate}
    ...
    \item \textbf{Zero-shot spatial generalisation}: A model trained on a $13{\times}13$ grid achieves $94\%$ success when transferred zero-shot to $20{\times}20$ and $25{\times}25$ grids (up from $84\%$ on the training grid), confirming size-invariant feature scaling and demonstrating that lower density clearance simplifies coordination detours.
\end{enumerate}
